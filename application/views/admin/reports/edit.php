				...
				<?php print form::open(NULL, array('enctype' => 'multipart/form-data', 'id' => 'reportForm', 'name' => 'reportForm')); ?>
					...
					<div class="report-form">
						...
						<div class="f-col">
							...
							<div class="row">
								<h4>Deskripsi Laporan <span><?php echo Kohana::lang('ui_main.include_detail');?>.</span> <span class="required">*</span></h4>
							...
							<div class="row">
								<h4>Kategeri Pelanggaran <span class="required">*</span></h4>
								...
								?>
           						...
           						<iframe style="background:#CCCCCC; padding:2px; border-radius:5px;" src="https://docs.google.com/forms/d/1CNjlxXFXQrLwqubD5s6JyJIzLvDG4u54Awr8nTLLFxI/viewform?embedded=true" width="368" height="160" scrolling="yes" frameborder="0" marginheight="0" marginwidth="0"></iframe>
						...
						<div class="f-col-1">
							...
							<div class="row">
								<div class="town">
									<h4>Lokasi Peristiwa  <span class="required">*</span><br /><span><?php echo Kohana::lang('ui_main.detailed_location_example');?></span></h4>
						...
						<div class="f-col-bottom-container">
							<div class="f-col-bottom">
								<div class="row">
									<h4>Data Pelapor <span style="font-size:11px; color:red">[wajib diisi]</span> <span class="required">*</span></h4>
									<label>
