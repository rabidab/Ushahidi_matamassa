<div id="main" class="report_detail" style="background:#F1F1F1; border-radius:0px 0px 5px 5px; box-shadow:0px 0px 5px 1px;">

	<div class="left-col" style="margin-top:60px;">
	...
	<div class="right-col" style="margin-top:60px;">
