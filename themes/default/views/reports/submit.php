		...
		<div class="big-block">
			...
			<div class="report_left">
				<div class="report_row">
					...
					<?php endif; ?>
					<h4>Judul Laporan <span class="required">*</span> </h4>
					<?php print form::input('incident_title', $form['incident_title'], ' class="text long"'); ?>
				</div>
				<div class="report_row">
					<h4>Deskripsi Laporan <span class="required">*</span> </h4>
					<div class="allowed-html" style="color:#0099cc; font-size:11px; margin-top:-5px; font-style:italic;">Penjelasan mengenai detail dugaan pelanggaran. Laporan setidaknya memuat<br />bentuk pelanggaran, pelaku, tempat dan waktu peristiwa.</div>
					<br />
				...
				<div class="report_row" id="datetime_default">
					<h4>
						<a href="#" id="date_toggle" class="show-more">Ubah Waktu</a>
						Tanggal & Jam : 
				...
				<div class="report_row">
					<h4>Kategori Pelanggaran <span class="required">*</span></h4>
					...
					<div style="font-size:11px; font-style:italic; color:#0099cc; margin-top:-5px; margin-left:10px;">Jika tidak bisa menentukan kategori yang tepat, pilih kategori lain - lain.</div>
					<br />
				...
				<div class="report_optional">
					<div style="color:#6E329D; letter-spacing:0.2em; font-family:Open Sans; font-size:20px;">DATA PELAPOR</div>
					<div style="font-size:11px; margin-top:2px; margin-bottom:10px; font-style:italic; color:#0099cc;">Pelapor wajib menulis identitas yang sebenarnya, data pelapor akan dijamin kerahasiaannya.</div>
					<div class="report_row">
						<div style="color:#888888; letter-spacing:0.2em; font-family:Open Sans; font-size:16px;">Nama Lengkap<span class="required">*</span></div>
						<?php print form::input('person_first', $form['person_first'], ' class="text long"'); ?>
					</div>
					<div class="report_row">
						<div style="color:#888888; letter-spacing:0.2em; font-family:Open Sans; font-size:16px;">Nomer Telepon<span class="required">*</span></div>
						<?php print form::input('person_last', $form['person_last'], ' class="text long"'); ?>
					</div>
					<div class="report_row">
						<div style="color:#888888; letter-spacing:0.2em; font-family:Open Sans; font-size:16px;">Email<span class="required">*</span></div>
			...
			<div class="report_right">
				...
				<div class="report_row">
					<h4>
						...
						<span class="example" style="font-style:italic; color:#0099cc;">Contoh : Jl. Raya Berita No.7 Sukoharjo, Jayapura, Papua - 12345.</span>
					</h4>
