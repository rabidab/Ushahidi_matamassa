...
<body>
	...
	<div class="holder">
		...
		<div id="header">
			...
			<div class="info-nav">
				...
				<ul>
					<li ><a href="#"><?php echo Kohana::lang('ui_admin.wiki');?></a></li>
					<li><a href="http://matamassa.org/blog">Blog</a></li>
					<li><a href="http://forum.matamassa.org"><?php echo Kohana::lang('ui_admin.forum');?></a></li>
				</ul>
			...
			<!-- title -->
			<h1><a href="http://www.matamassa.org" target="_blank"><img style="width:340px;" src="http://www.matamassa.org/media/uploads/banner_1385164216.png" alt="MataMassa" /></a></h1>
			<!-- nav-holder -->
			<div class="nav-holder">
				<!-- main-nav -->
				<ul class="main-nav">
					
					<li><a href="http://www.matamassa.org/admin/dashboard" class="active">Dashboard</a></li>
					<li><a href="http://www.matamassa.org/admin/reports">Reports</a></li>
					<li><a href="http://www.matamassa.org/admin/messages">Messages</a></li>
					<li><a href="http://www.matamassa.org/admin/stats">Stats</a></li>
	...
	<div id="footer">
		...
		Dikembangkan oleh:  
			<strong style="margin-top:5px; font-family:Raleway; font-size:24px;">
				iLab & AJI Jakarta
