...
<div style="font-size:24px; font-family:Roboto; padding-bottom:5px;">Cara Melapor</div>
	...
	<tr>
	<td style="width:35px">
	<img width="34" height="35" src="<?php echo url::site();?>themes/default/images/mail.png" alt="SMS" /> 
	</td>
	<td>
	...
	<tr>
	<td style="width:35px">
	<img width="34" height="35" src="<?php echo url::site();?>themes/default/images/web.png" alt="SMS" /> 
	</td>
	<td>
