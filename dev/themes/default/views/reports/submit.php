		...
		<div class="big-block">
			...
			<div class="report_left">
				...
				<div class="report_row">
					...
					<?php print form::textarea('incident_description', $form['incident_description'], ' rows="10" class="textarea long" placeholder="Contoh laporan:
			      Telah ditemukan dugaan pelanggaran yang dilakukan oleh ..., caleg dari Partai ... untuk DPR-RI/DPRD Dapil ... Nomor Urut ... 
Dugaan pelanggaran ditemukan di Jalan ... kecamatan ..., Kelurahan ..., Kabupaten ..., Provinsi ... 
Sampai dengan hari ..., tanggal/bulan/tahun, dugaan pelanggaran tersebut masih ditemukan." class="findtext texthint" ') ?>
