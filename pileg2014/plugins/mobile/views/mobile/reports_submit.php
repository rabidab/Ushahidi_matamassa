<div class="report_submit">
	<h2 class="main_title" style="font-family:Roboto;">Kirim Laporan Baru</h2>
...
?>
	<div class="report_form">
		...
		?>
		<!-- red-box -->
		<div class="red-box" style="border-radius:5px;">
			<h3>Error!</h3>
			<ul>
				<?php
...
*/ ?>
		<div class="report_row">
			<span class="location">Tuliskan Lokasi Kejadian</span>
		...
		<div class="report_row">
		<h4>Nomor Telepon <span class="required">*</span></h4>
