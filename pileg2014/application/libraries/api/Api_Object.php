...
abstract class Api_Object_Core {
	...
	{
               // header("Access-Control-Allow-Orgin: *"); //tambahan
               // header("Access-Control-Expose-Headers: Access-Control-Allow-Origin"); //tambahan
               //  header("Access-Control-Allow-Headers", "Origin, X-Requested-With, Content-Type, Accept"); //tambahan
