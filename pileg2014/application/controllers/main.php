...
class Main_Controller extends Template_Controller {
	...
	public function repstat()
	{
		...
		//$this->themes->js = new View('main/stats_js');
			...
			$this->template->content->stas->reports_chart = $reports_chart->chart('reports',$report_data,$options,$colors,200,200);
