...
<div style="margin-top:5px; margin-bottom:2px; font-family:Roboto; font-size:16px;">
			...
			<tr>
			<td style="height:245px; border: 1px solid #E5E5E5; border-radius:5px;">
			<span style="padding:10px 10px 10px 10px;">
			<a href="http://ajijakarta.org" target="_blank"><img style="margin-left:10px;" src="<?php echo url::site();?>themes/default/images/ajijak_l.png" alt="AJI Jakarta" /></a></span>
			...
			<td  style="height:250px; width:620px; border: 1px solid #E5E5E5; border-radius:5px;">
			
			<a href="http://sea.hivos.org" target="_blank"><img width="350" style="float:left; padding-left:20px; padding-top:10px;" src="<?php echo url::site();?>themes/default/images/seatti_p.png" alt="SEATTI" /></a>
			
			<a href="http://change.org/id/" target="_blank"><img width="150" style="float:left; padding-left:20px; padding-top:40px;" src="<?php echo url::site();?>themes/default/img/change.png" alt="Change.org" /></a>
			...
			<a href="http://jasnita.co.id/" target="_blank"><img style="float:left; padding-left:10px;" src="<?php echo url::site();?>themes/default/img/jasnita.png" alt="JASNITA" /></a>
			
			<a href="#" target="_blank"><img style="float:left; padding-left:10px;" src="<?php echo url::site();?>themes/default/img/wa.png" alt="Wretta Aksa" /></a>
			...
			<a href="#" target="_blank"><img style="float:left; padding-left:10px;" src="<?php echo url::site();?>themes/default/img/didakta.png" alt="Didakta" /></a>
			
			<a href="#" target="_blank"><img style="float:left; padding-left:10px;" src="<?php echo url::site();?>themes/default/img/orange.png" alt="Orange" /></a>
			
			<a href="#" target="_blank"><img style="float:left; padding-left:10px;" src="<?php echo url::site();?>themes/default/img/greenradio.png" alt="Green Radio" /></a>
			
			<a href="http://tempo.co/" target="_blank"><img width="110" style="float:left; padding-left:20px; padding-top:15px;" src="<?php echo url::site();?>themes/default/img/tempo.png" alt="TEMPO" /></a>
