...
<table class="table-list">
	...
	<tbody>
		...
		<tr>
		<?php require('../blog/wp-load.php'); query_posts('cat=1&showposts=3');  if (have_posts()) : while (have_posts()) : the_post(); ?>
...
<div class="morre">
<a href="http://www.matamassa.org/blog/category/kolom/"><?php echo Kohana::lang('ui_main.view_more'); ?></a>
</div>
...
<table class="table-list">
	...
	<thead>
		<tr>
			<div style="font-size:24px; font-family:Roboto; margin-top:43px;">Rilis dan Publikasi</div>
			<th scope="col" class="title"><?php echo Kohana::lang('ui_main.title'); ?></th>
			<th scope="col" class="date"><?php echo Kohana::lang('ui_main.date'); ?></th>
		</tr>
	</thead>
	<tbody>		
		...
		<?php require('../blog/wp-load.php'); query_posts('cat=16&showposts=3');  if (have_posts()) : while (have_posts()) : the_post(); ?>
...
<div class="morre">
<a href="http://www.matamassa.org/blog/category/rilis-publikasi"><?php echo Kohana::lang('ui_main.view_more'); ?></a>
</div>
