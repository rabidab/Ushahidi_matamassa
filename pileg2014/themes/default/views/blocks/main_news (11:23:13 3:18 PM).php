<table valign="top" style="margin-top:-10px;">
<tr>
<td valign="top">
<li id="block-news">
<div class="content-block" style="margin-top:-2px;">
...
<table class="table-list">
	...
	<tbody>
		...
		<?php require('blog/wp-load.php'); query_posts('showposts=10');  if (have_posts()) : while (have_posts()) : the_post(); ?>
		
				<td><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title_limit(40, '...'); ?></a></td>
...
<div style="font-size:24px; font-family:Roboto; margin-top:-4px;">
Berita Pemilu
</div>
