		...
		<div class="big-block">
			...
			<div class="report_left">
				...
				<div class="report_row">
					...
					<div class="allowed-html" style="color:red; font-size:11px; margin-top:-5px; font-style:italic;">Penjelasan mengenai detail dugaan pelanggaran. Laporan setidaknya memuat<br />bentuk pelanggaran, pelaku, tempat dan waktu peristiwa.</div><br />
					
					<?php print form::textarea('incident_description', $form['incident_description'], ' rows="10" class="textarea long" style="font-size:11px; height:170px;" placeholder="Contoh laporan: 														Telah ditemukan dugaan pelanggaran yang dilakukan oleh ........, caleg dari Partai ........ untuk DPR-RI/DPRD Dapil ........ Nomor Urut ........																Temuan dugaan pelanggaran tersebut berupa ........ 																	Dugaan pelanggaran ditemukan di Jalan..... kecamatan ......, Kelurahan....., Kabupaten ......, Provinsi ...... 																	Sampai dengan hari ...., tanggal/bulan/tahun, dugaan pelanggaran tersebut masih ditemukan." class="findtext texthint" ') ?>
				...
				<div class="report_row">
					...
					<div style="font-size:11px; font-style:italic; color:red; margin-top:-5px; margin-left:10px;">Jika tidak bisa menentukan kategori yang tepat, pilih kategori lain - lain.</div>
					<br />					
				</div>
				...
				<div class="report_optional">
					<h3>Data Pelapor</h3>
						<div style="font-size:11px; margin-top:-15px; font-style:italic; color:red;">Pelapor wajib menulis identitas yang sebenarnya, data pelapor akan dijamin kerahasiaannya.</div><br /> 
					<div class="report_row">
						<h4>Nama Lengkap <span class="required">*</span></h4>
						<?php print form::input('person_first', $form['person_first'], ' class="text long"'); ?>
					</div>
					<div class="report_row">
						<h4>Nomer Telepon <span class="required">*</span></h4>
			...
			<div class="report_right">
				...
				<div class="report_row" style="font-size:12px; font-style:italic; color:red;">Semua form isian yang bertanda * wajib di isi, untuk standarisasi pelaporan MataMassa.</div>
									
				<div class="report_row">
					<input name="submit" type="submit" value="Kirim Laporan" class="btn_submit" /> 
				</div>
			</div>
		</div>
