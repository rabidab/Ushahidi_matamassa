	...
	public function submit($saved = false)
	{
		...
		(
            ...
            */
			...
			'person_first' => '', //tambahan permintaan dari training hotel paragon
			'person_last' => '',
			'person_email' => '',
		);
		...
		if ($_POST)
		{
			...
			$post->add_rules('person_first', 'required', 'length[3,100]'); //permintaan via whatsapp
			$post->add_rules('person_last', 'required', 'numeric', 'length[6,12]'); //permintaan via whatsapp
			...
			if ($post->validate())
			{
				...
				//$incident->user_id = "NULL"; //dihilangkan tgl 18 juni 2014
				$incident->incident_title = $post->incident_title;
				$incident->incident_description = $post->incident_description;
				
				$person = new Incident_Person_Model(); //tambahan permintaan dari hotel paragon
